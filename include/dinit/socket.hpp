#ifndef DINIT_SOCKET_HPP
#define DINIT_SOCKET_HPP
...
inline int dinit_accept4(int sockfd, struct sockaddr *addr, socklen_t *addrlen,
                         int flags) {
...
inline int dinit_socketpair(int domain, int type, int protocol,
                            int socket_vector[2], int flags) {
